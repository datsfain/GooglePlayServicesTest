...
namespace GooglePlayGames.Android
{
    ...
    internal class AndroidSavedGameClient : ISavedGameClient
    {
        ...
        // this method was not implemented idk why
        public void OpenWithAutomaticConflictResolution(string v, DataSource readCacheOrNetwork, object onSaveGameOpen)
        {
            OpenWithAutomaticConflictResolution(v, readCacheOrNetwork, (Action<SavedGameRequestStatus, ISavedGameMetadata>)onSaveGameOpen);
        }
